#pragma checksum "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2b9665ece9a66c004c23049ff447c830bb02ae43"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2b9665ece9a66c004c23049ff447c830bb02ae43", @"/Views/Home/Administrator_Menu_2.cshtml")]
...
<div style=""position: absolute; top: 15%; width: 50%; left: 25%; right: 25%; height: 85%;"">
    ...
    <div id=""floors"" ");
            WriteLiteral("class=\"hidden\" style=\"top: 30%; position: absolute; width: 25%; max-height: 50%; overflow-y: auto; z-index: 1; background-color: white; border-left: 1px solid grey; border-bottom: 1px solid grey; border-right: 1px solid grey;\">\r\n");
#nullable restore
#line 51 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
...
#nullable restore
#line 53 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
                                                     Write(i);
...
#line hidden
#nullable disable
            WriteLiteral("        <p id=\"floor_add\" class=\"dropdown-element\" style=\"margin: 0; width: 100%; height: 100%;\">Adăugați un etaj</p>\r\n    </div>\r\n    <div style=\"width: 100%; height: 68%; position: relative; display: flex; flex-wrap: wrap;\">\r\n\r\n");
#nullable restore
#line 59 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
         for (int i = 0; i < 9; i++)
        {
...
");
#nullable restore
#line 64 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
            }
...
#nullable disable
            WriteLiteral("            <div class=\"building_map\" data-row=\"");
#nullable restore
#line 65 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
                                           Write(i);

#line default
#line hidden
#nullable disable
            WriteLiteral(@""" data-col=""9"" style=""width: 10%; height: 10%; position: relative;""><svg style=""width: 100%; height: 100%;""><line class=""line"" style=""display: none;"" data-orientation=""upper"" x1=""0"" x2=""100%"" y1=""0"" y2=""0"" stroke=""black"" stroke-width=""5px"" /><line class=""line"" style=""display: none;"" data-orientation=""left"" x1=""0"" x2=""0"" y1=""0"" y2=""100%"" stroke=""black"" stroke-width=""5px"" /><line class=""line"" style=""display: none;"" data-orientation=""right"" x1=""100%"" x2=""100%"" y1=""0"" y2=""100%"" stroke=""black"" stroke-width=""5px"" /></svg></div>
");
#nullable restore
#line 66 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
        }
...
#nullable disable
#nullable restore
#line 67 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
         for (int j = 0; j < 9; j++)
        {
...
#line hidden
#nullable disable
            WriteLiteral("            <div class=\"building_map\" data-row=\"9\" data-col=\"");
#nullable restore
#line 69 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
                                                        Write(j);
...
");
#nullable restore
#line 70 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
        }
...
<script>
    ...
    $('#toolbox_wall, #toolbox_desk, #toolbox_chair').mouseenter(function () {
        ...
        if (!$(this).is(':animated')) {
            $(this).animate({
          ");
            WriteLiteral(@"      backgroundColor: ""#A1A9A8""
    ...
    $('html').on(""mousedown"", function (e) {
        if (!$('#floors').hasClass('hidden') && !$(e.target).hasClass(""dropdown-element"") && e.target.id");
            WriteLiteral(@" != ""current_floor"")
    ...
    $('html').mousemove(function (e) {
        if ($('#created_icon').length != 0) {
            ...
            else if (e.pageX - $('#created_icon').outerWidth() / 2 < 0 && e.pageY - $('#created_icon').outerHeight() / 2 > 0 && e.pageY + $('#created_icon').outerHeight() / 2 <= $(window).");
            WriteLiteral(@"height())
            ...
            else if (e.pageX - $('#created_ic");
            WriteLiteral(@"on').outerWidth() / 2 > 0 && e.pageY - $('#created_icon').outerHeight() / 2 < 0 && e.pageX + $('#created_icon').outerWidth() / 2 > $(window).width())
            ...
            else if (e.pageX + $('#created_icon').outerWidth() / 2 > $(window).widt");
            WriteLiteral(@"h() && e.pageY + $('#created_icon').outerHeight() / 2 > $(window).height())
            ...
            if ((pin.dataset.orientation == ""upper"" || pin.dataset.orientation == ""bottom"") && e.pageX - lastX < -3) {
                if (j > 0) {
                    ...
                    var ta");
            WriteLiteral(@"rget = document.querySelector('.building_map[data-row=""' + i + '""][data-col=""' + j + '""]');
                    ...
                    if (line.dataset.orientation == ""upper"")
                        pin.sty");
            WriteLiteral(@"le.top = ""-"" + pin.offsetHeight + ""px"";
                ...
                if (current.querySelectorAll('.created_pin').length != 2) {
                    ...
                    var line = current.query");
            WriteLiteral(@"Selector('svg > line[data-orientation=""' + pin.dataset.orientation+'""]');
                    ...
                    ");
            WriteLiteral(@"$(pin).mousedown(function (e) {
                        pin1_hold = true;
                        $('line:not(.added)').css('stroke', 'green').css('display', '');
                        lastX = e.pageX;
                        lastY = e.pageY;
                ...
                if (i > 0) {
                    ...
                    pin.remove();
                    pin = document.createElement('pin');
                    pin.className = ""fas fa");
            WriteLiteral(@"-map-pin created_pin""
                    pin.style.cursor = ""pointer"";
                    pin.style.color = ""green"";
                    pin.style.position = ""absolute"";
                    ...
                    $(pin).mousedown(function (e) {
                        pin1_hold = true;
             ");
            WriteLiteral(@"           $('line:not(.added)').css('stroke', 'green').css('display', '');
                        lastX = e.pageX;
                        lastY = e.pageY;
                    });
                }
                ...
                if (current.querySelectorAll('.created_pin').length != 2) {
                    ...
                    var target = document.querySelector('.building_map[data-row=""' + i + '""][data-col=""' + j + '""]');
                  ");
            WriteLiteral(@"  var line = current.querySelector('svg > line[data-orientation=""' + pin.dataset.orientation + '""]');
                    line.style.stroke = ""green"";
                    line.style.strokeWidth = ""5px"";
                    $(line).removeClass('added');
                    pin.remove();
...
");
            WriteLiteral(@"                if (j < 9) {
                    ...
                    target.appendChild(pin);
     ");
            WriteLiteral(@"               if (line.dataset.orientation == ""upper"")
                        pin.style.top = ""-"" + pin.offsetHeight + ""px"";
                    else if (line.dataset.orientation == ""bottom"")
                        pin.style.bottom = ""5px"";
                    $(pin).mousedown(function (e) {
                ...
                if (current.querySelectorAll('.created_pin').length != 2) {
                    j = +j - 1;
                    var target = document.querySelector('.building_map[data-row=""' + i + '""][d");
            WriteLiteral(@"ata-col=""' + j + '""]');
   ...
   ");
            ...
            WriteLiteral(@"'added');
                    ...
                    if (line.dataset.orientation == ""left"")
                        ...
                        pin.sty");
            WriteLiteral(@"le.right = ""-"" + pin.offsetHeight + ""px"";
                    $(pin).mousedown(function (e) {
                        pin2_hold = true;
                        $('line:not(.added)').css('stroke', 'green').css('display', '');
                        lastX = e.pageX;
    ...
    $('html').mouseup(function (e) {
        if ($('#created_icon').length != 0) {
            ...
            WriteLiteral(@"stX = e.pageX;
                    ...
                    ");
            WriteLiteral(@"pin.style.right = ""-"" + pin.offsetHeight + ""px"";
                }
            }
        ...
        for (var i = 0; i < 10; i++)
            for (var j = 0; j < 10; j++) {
                ...
                if (line.find('line[data-orientation=""bottom""]').eq(0).hasClass('added'))
                    ...
                    walls += ""0 "";
      ");
            WriteLiteral(@"          if (line.find('line[data-orientation=""right""]').eq(0).hasClass('added'))
                    walls += ""1] "";
                else
                    walls += ""0] "";
    ...
    function dropdown_click(dropdown) {
        ...
        else if (dropdown.attr('id') == ""fl");
            WriteLiteral(@"oor_add"") {
    ...
    $(""#profile_pic_select"").change(function () {
        ...
        if (input.files && input.files[0]) {
            ...
            if (filesize > 5) {
                ...
                read");
            WriteLiteral("er.onload = function (e) {\r\n                    $(\"#profile_pic\").attr(\"src\", e.target.result);\r\n                    $.ajax({\r\n                        url: \"/\",\r\n                        method: \"POST\",\r\n                        data: { \"uid\": \"");
#nullable restore
#line 701 "E:\Faculta\IP\Proiect Smart View Access\Proiect-Smart-View-Access\dotnetnewmvc\Views\Home\Administrator_Menu_2.cshtml"
                                   Write(ViewBag.uid);
